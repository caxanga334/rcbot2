...
#ifdef __linux__
#define BOT_VER "TF2/HL2DM/DOD:S/SYNERGY 1.05 META Linux 489 (merge) (BUILD " __DATE__ "-" __TIME__ ")" //bir3yk
#else
#define BOT_VER "TF2/HL2DM/DOD:S/SYNERGY 1.05 META Win32 489 (merge) (BUILD " ## __DATE__ ## "-" ## __TIME__ ## ")"
#endif
