...
bool CBotSynergy::isEnemy(edict_t *pEdict, bool bCheckWeapons)
{
	...
	if (strncmp(szclassname, "npc_", 4) == 0) // Attack NPCs
	{
		if (strcmp(szclassname, "npc_metropolice") == 0 || strcmp(szclassname, "npc_combine_s") == 0 || strcmp(szclassname, "npc_manhack") == 0 ||
			...
			strcmp(szclassname, "npc_barnacle") == 0 || (strcmp(szclassname, "npc_combinegunship") == 0) || (strcmp(szclassname, "npc_helicopter") == 0) || (strcmp(szclassname, "npc_strider") == 0) || (strcmp(szclassname, "npc_combinedropship") == 0) || (strcmp(szclassname, "npc_clawscanner") == 0) || (strcmp(szclassname, "npc_combine_camera") == 0) || (strcmp(szclassname, "npc_antlion_worker") == 0) || (strcmp(szclassname, "npc_cscanner") == 0))
		{
			return true;
		}
	}
